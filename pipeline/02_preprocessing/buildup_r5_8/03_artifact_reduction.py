...
dir_R5_8_filteredData = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R5-8/Preprec_withartifacts')
...
dir_R5_8_PreprocessedData = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R5-8/PreprocessedData')
...
for rat in rats  :  #for rat in [rats[0]]   for rat in rats
    ...
    for region in regions: # for region in [regions[0]] for region in regions
        ...
        dir_R5_8_filteredData_perday = os.path.join(dir_R5_8_filteredData, region, str(rat))
        folders_SD = [name for name in os.listdir(dir_R5_8_filteredData_perday)
                      if os.path.isdir(os.path.join(dir_R5_8_filteredData_perday, name))]
        ...
        for studyday in folders_SD: #for studyday in [folders_SD[0]] for studyday in folders_SD
            ...
            for sleep_period in sleep_periods:  #for sleep_period in sleep_periods
                ...
                dir_R5_8_RawData_pertrial = os.path.join(dir_R5_8_filteredData_perday, studyday, sleep_period)
                All_files = []
                ...
                for file in All_files:
                    ...
                    if len(os.listdir(path_scoring)) == 1:
                        trial_scoring_data = loadmat(os.path.join(path_scoring, os.listdir(path_scoring)[0]))
                    ...
                    save_dir = os.path.join(dir_R5_8_PreprocessedData, region,str(rat),studyday,sleep_period)
