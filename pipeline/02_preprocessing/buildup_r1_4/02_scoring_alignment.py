...
dir_R1_4_Data = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/Preprec_withartifacts')
...
dates = ['20220929','20221003','20221006','20221021','20221103']
...
for rat in rats:  #for rat in [rats[0]]   rat in rats
    ...
    for region in regions: # for region in [regions[0]]  region in regions
        ...
        dir_R1_4_RawData_perday = os.path.join(dir_R1_4_Data,region,str(rat))
                    ...
                    for file in matched_files:
                        ...
                        if len(data) not in expected_lengths:
                            ...
                            if len(data) > len(scoring_data)*fs:
                                ...
                                savemat(os.path.join(path_scoring, f), {'states': scoring_data_new})
