...
dir_R1_4_RawData = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/RawData')
dir_R1_4_Scoring = os.path.join(dir_base2,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Sleepscoring_results_R1-4')

dir_R1_4_Preprec_withartifacts = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/Preprec_withartifacts')
# this folder will store the preprocessed data
dir_R1_4_Scoring_withartifacts = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/Scoring')
...
for rat in rats:  #for rat in [rats[0]]   rat in rats
    ...
    for region in regions : # for region in [regions[0]]  region in regions
        ...
        folders_SD = [name for name in os.listdir(dir_R1_4_RawData_perday)
        ...
        for studyday in folders_SD: #for studyday in [folders_SD[0]] studyday in folders_SD
            ...
            for sleep_period in sleep_periods:  #for sleep_period in sleep_periods
                ...
                dir_R1_4_RawData_pertrial = os.path.join(dir_R1_4_RawData_perday, studyday, sleep_period)
                matched_files = []
                ...
                dir_R1_4_Scoring_pertrial = os.path.join(dir_R1_4_Scoring, str(rat), studyday, sleep_period)
                ...
                for trial_name, files in grouped.items():  #for trial_name, files in [list(grouped.items())[0]]: for trial_name, files in grouped.items()
                   ...
                   # Keep only the first 30 minutes of data
                    ...
                    save_dir = os.path.join(dir_R1_4_Preprec_withartifacts, region,str(rat),studyday,sleep_period)
                ...
                for scoring_name in matched_scoringfiles:
                    ...
                    save_dir_scoring = os.path.join(dir_R1_4_Scoring_withartifacts,str(rat),studyday,sleep_period)
