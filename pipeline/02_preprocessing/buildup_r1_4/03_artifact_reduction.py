...
dir_R1_4_filteredData = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/Preprec_withartifacts')
...
dir_R1_4_PreprocessedData = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/PreprocessedData')
...
for rat in rats:  #for rat in [rats[0]]   for rat in rats
    ...
    for region in regions: # for region in [regions[0]] for region in regions
        ...
        dir_R1_4_filteredData_perday = os.path.join(dir_R1_4_filteredData,region,str(rat))
        folders_SD = [name for name in os.listdir(dir_R1_4_filteredData_perday)
        ...
        for studyday in folders_SD: #for studyday in [folders_SD[0]] for studyday in folders_SD
            ...
            for sleep_period in sleep_periods:  #for sleep_period in sleep_periods
                ...
                dir_R1_4_RawData_pertrial = os.path.join(dir_R1_4_filteredData_perday, studyday, sleep_period)
                All_files = []
                ...
                for file in All_files:
                    ...
                    save_dir = os.path.join(dir_R1_4_PreprocessedData, region,str(rat),studyday,sleep_period)
