...
dir_R9_12_Data = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R9-12/Preprec_withartifacts')
...
dates = ['20230710','20230712','20230715','20230718','20230724','20230725','20230728','20230731','20230802','20230804','20230808',
         '20230822','20230831','20230901']
                    ...
                    for file in matched_files:
                        ...
                        if len(data) not in expected_lengths:
                            ...
                            if len(data) > len(scoring_data)*fs:
                                print(f"Data length in {file} is longer than scoring length, pad with 0")
                                pad_len = math.floor(len(data) / fs) - len(scoring_data)
                                scoring_data_new = np.concatenate([scoring_data, np.full(pad_len, 0)])
                            ...
                            if len(scoring_data)*fs < len(data):
                                print(f"Sleep scoring {file} is shorter than expected, pad with 0")
