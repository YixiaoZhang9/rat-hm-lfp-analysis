...
dir_R9_12_filteredData = os.path.join(
    dir_base1, "Rat_HM_Ephys_TD_Analysis_R9_16/R9-12/Preprec_withartifacts"
)
...
dir_R9_12_PreprocessedData = os.path.join(
...
for rat in rats:  # for rat in [rats[0]]   for rat in rats
    for region in [regions[0]]:  # for region in [regions[0]] for region in regions
        ...
        folders_SD = [
            name
            for name in os.listdir(dir_R9_12_filteredData_perday)
        ...
        for (
            ...
            for sleep_period in sleep_periods:  # for sleep_period in sleep_periods
                ...
                dir_R9_12_RawData_pertrial = os.path.join(
                    dir_R9_12_filteredData_perday, studyday, sleep_period
                )
                All_files = []
