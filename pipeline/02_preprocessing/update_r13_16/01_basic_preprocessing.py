...
dir_R13_16_RawData = os.path.join(dir_base, 'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R13-16/RawData')
dir_R13_16_Scoring = os.path.join(dir_base, 'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Sleepscoring_results_R13-16')

dir_R13_16_Preprec_withartifacts = os.path.join(dir_base, 'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R13-16/Preprec_withartifacts')
# this folder will store the preprocessed data
dir_R13_16_Scoring_withartifacts = os.path.join(dir_base, 'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R13-16/Scoring')
...
dates_special_handels6= ['20230711','20230716','20230717','20230721','20230724','20230801','20230804']
...
for rat in [rats[3]]:  #for rat in [rats[0]]   rat in rats
    ...
    for region in [regions[0]]: # for region in [regions[0]]  region in regions
        ...
        folders_SD = [name for name in os.listdir(dir_R13_16_RawData_perday)
        ...
        for studyday in folders_SD: #for studyday in [folders_SD[0]] studyday in folders_SD
            ...
            for sleep_period in sleep_periods:  #for sleep_period in sleep_periods
                ...
                dir_R13_16_RawData_pertrial = os.path.join(dir_R13_16_RawData_perday, studyday, sleep_period)
                matched_files = []
                ...
                dir_R13_16_Scoring_pertrial = os.path.join(dir_R13_16_Scoring, str(rat), studyday, sleep_period)
                ...
                for trial_name, files in grouped.items():  #for trial_name, files in [list(grouped.items())[0]]: for trial_name, files in grouped.items()
                   ...
                   # Keep only the first 30 minutes of data
                    ...
                    save_dir = os.path.join(dir_R13_16_Preprec_withartifacts, region, str(rat), studyday, sleep_period)
                ...
                for scoring_name in matched_scoringfiles:
                    ...
                    save_dir_scoring = os.path.join(dir_R13_16_Scoring_withartifacts, str(rat), studyday, sleep_period)
