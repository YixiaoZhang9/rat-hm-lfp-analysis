...
dir_R13_16_RawData = os.path.join(
    dir_base, "Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R13-16/RawData"
)
dir_R13_16_Scoring = os.path.join(
    dir_base, "Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Sleepscoring_results_R13-16"
)

dir_R13_16_Preprec_withartifacts = os.path.join(
    dir_base, "Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R13-16/Preprec_withartifacts"
)
# this folder will store the preprocessed data
dir_R13_16_Scoring_withartifacts = os.path.join(
    dir_base, "Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R13-16/Scoring"
)
