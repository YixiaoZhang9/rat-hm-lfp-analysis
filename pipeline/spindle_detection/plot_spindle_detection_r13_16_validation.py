...
dir_R13_16_condition = os.path.join(
    dir_data_root, "Rat_HM_Ephys_TD_R13_16_Overview_StudyDay_Condition.xlsx"
)
        ...
        for studyday in os.listdir(dir_rat):
            for sleep_period in sleep_periods:
                ...
                dir_spindle = os.path.join(
                    dir_R13_16_Spindle, region, str(rat), studyday, sleep_period
                )
