...
dir_R5_8_Spindle = os.path.join(dir_data_root, "Spindle_detection_results")
dir_R5_8_condition = os.path.join(
...
xls = pd.ExcelFile(dir_R5_8_condition)
rat_conditions = {}

for sheet in xls.sheet_names:
    df_cond = pd.read_excel(dir_R5_8_condition, sheet_name=sheet)
