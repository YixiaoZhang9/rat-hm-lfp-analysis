...
dir_data_root = os.path.join(dir_base1, "Rat_HM_Ephys_TD_Analysis_R1_8/R1-4")
...
dir_R1_4_condition = os.path.join(
        ...
        for studyday in os.listdir(dir_rat):
            for sleep_period in sleep_periods:
                ...
                dir_spindle = os.path.join(
                    dir_R1_4_Spindle, region, str(rat), studyday, sleep_period
                )
