...
dir_R1_4_Spindle = os.path.join(dir_data_root, 'Spindle_detection_results')
dir_R1_4_condition = os.path.join(dir_data_root, 'Rat_HM_Ephys_TD_R1_4_Overview_StudyDay_Condition.xlsx')
...
xls = pd.ExcelFile(dir_R1_4_condition)
rat_conditions = {}

for sheet in xls.sheet_names:

    df_cond = pd.read_excel(dir_R1_4_condition, sheet_name=sheet)
    ...
    for region in ['HPC']:
        ...
        for studyday in os.listdir(dir_rat):
            ...
            for sleep_period in sleep_periods:
                ...
                dir_spindle = os.path.join(dir_R1_4_Spindle, region, str(rat), studyday, sleep_period)
...
# ---- Find ripple CSVs ----
dir_spindle = os.path.join(dir_R1_4_Spindle, region, rat, studyday, sleep_period)
