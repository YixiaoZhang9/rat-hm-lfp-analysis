...
class SpindleViewer(QWidget):
    ...
    def __init__(self, lfp, scoring, fs, event_sets=None):
        ...
        self.filtered = filter_lfp(lfp, fs, [9, 20])
    ...
    def add_legends(self):
        ...
        for i, method in enumerate(self.event_sets.keys()):
            ...
            spindle_legend.append(Line2D([0], [0], color=color, lw=3, label=method))
    ...
    def update_plot(self):
        ...
        self.ax_filtered.set_ylabel("9_20_Hz_filtered_signal", fontsize=13)

        # --- Sleep background ---
        self.plot_sleep_background(start, end)

        # --- Ripple bars ---
        self.plot_spindles(start, end)
    ...
    def plot_spindles(self, start, end):
