...
dir_R1_4_Spindle = os.path.join(dir_base1, 'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/Spindle_detection_results')
...
#-----------------------------------------------------------------------------------
#------------------------------plot the spindle rate per day per rat-----------------

#%%
# Compute spindle rate (spindles / min in NREM)
