...
dir_output = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/Delta_detection_results')
            ...
            for sleep_period in sleep_periods:
                ...
                for trial_name in matched_files:
                    ...
                    for (start_sample, end_sample) in NREM_bouts:
                        ...
                        # delta detection
                        deltas = find_deltas_lfp(bout_raw_data, bout_data, fs=fs,thresholds=(1, 2, 0, 1.5),durations=(250, 1500),f_plot = False,plot_range=None)
