...
dir_R5_8_Delta = os.path.join(dir_base1, 'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R5-8/Delta_detection_results')
...
# ---- Find ripple CSVs ----
dir_delta = os.path.join(dir_R5_8_Delta, region, rat, studyday, sleep_period)
csv_threshold = os.path.join(dir_delta, f"{trial_id}_deltas.csv")
