...
dir_R9_12_Delta = os.path.join(dir_base1, 'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R9-12/Delta_detection_results')
    ...
    for region in ['PL']:
        ...
        for studyday in os.listdir(dir_data):
            ...
            for sleep_period in sleep_periods:
                ...
                dir_delta = os.path.join(dir_R9_12_Delta, region, str(rat), studyday, sleep_period)
