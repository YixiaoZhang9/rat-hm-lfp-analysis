    ...
    for region in ['HPC']:
        ...
        for studyday in sorted(os.listdir(dir_rat)):
            ...
            for sleep_period in sleep_periods:
                ...
                dir_delta = os.path.join(dir_R1_4_Delta, region, str(rat), studyday, sleep_period)
...
for ax, (_, row) in zip(axes, sample_df.iterrows()):
    ...
    t, seg, dstart, dend = extract_delta_segment(
        trial_path,
        start_idx,
        end_idx
    )
