...
dir_R5_8_Data = os.path.join(dir_base,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_OpenEphysRecordings_R5-8/')
dir_results_base = '/media/yixiao/GL14_RAT_FA/'
dir_R5_8_results = os.path.join(dir_results_base,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R5-8/')
path_csv_overview_StudyDay = os.path.join(dir_R5_8_results,'Rat_HM_Ephys_TD_R5_8_Overview_StudyDay.csv')
path_csv_SelectedChannel = os.path.join(dir_R5_8_results, 'Rat_HM_Ephys_TD_R1_8_SelectedChannel.csv')
path_csv_postfix_trial = os.path.join(dir_R5_8_results,'Rat_HM_Ephys_TD_R5_8_Suffix_Trial.csv')
path_csv_R5_8_20221005_Folder_SelectedChannel = os.path.join(dir_R5_8_results,'Rat_HM_Ephys_TD_R5_8_20221005_Folder_SelectedChannel.csv')
path_csv_R5_20221007_Folder_SelectedChannel = os.path.join(dir_R5_8_results,'Rat_HM_Ephys_TD_R5_20221007_Folder_SelectedChannel.csv')
date_prefix = 'Rat_HM_Ephys_TD_R5-8_'
rats = np.arange(5,9) # already modified, original rats = np.arange(5,9)


dates_all = ['20220927','20220929','20220930','20221003','20221005','20221007',
             '20221012','20221014','20221017','20221018','20221019','20221021','20221024','20221028',
             '20221031','20221101','20221102','20221107','20221108','20221109', '20221111', '20221117',
             '20221118', '20221121', '20221123','20221124','20221125','20221128','20221129', '20221205',
             '20221206', '20221207','20221209']
...
for rat in rats:
    ...
    for region in regions:
        default_channel = fstore.get_selected_channel(path_csv_SelectedChannel, rat, region)
        ...
        for date in dates_all:
            ...
            if date in dates_special_handles1:
                ...
                for period in sleep_period:
                    fstore.save_sleep_recording(path_recording, period, default_channel, region_result_dir, period)
            ...
            # Case 2: Special days with specific filepath and selected channel (e.g., 20221005,20221007)
                ...
                for idx in pre_suffix + post_suffix:
                    if idx in ['_2a', '_2b', '_2c']:
                        ...
                        this_folder, this_channel = fstore.get_folder_selected_channel_r5_8_20221005(
                            path_csv_R5_8_20221005_Folder_SelectedChannel, rat, region, idx
                        )

                    path_recording = os.path.join(dir_R5_8_Data, this_folder)
                    period = 'presleep' if idx in pre_suffix else 'postsleep'
                    fstore.save_sleep_recording(path_recording, idx, this_channel, region_result_dir, period,filename_suffix=idx)
            ...
            # Case 3: Special days with specific filepath and selected channel (20221007)
                ...
                for idx in pre_suffix + post_suffix:
                    ...
                    period = 'presleep' if idx in pre_suffix else 'postsleep'
                    fstore.save_sleep_recording(path_recording, idx, channel, region_result_dir, period,filename_suffix=idx)
            ...
            # Case 4: normal days
                ...
                for idx in pre_suffix + post_suffix:
                    period = 'presleep' if idx in pre_suffix else 'postsleep'
                    fstore.save_sleep_recording(path_recording, idx, default_channel, region_result_dir, period, filename_suffix=idx)
