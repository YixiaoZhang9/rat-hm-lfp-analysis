...
dir_data_root = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R13-16')
...
dir_condition = os.path.join(dir_data_root, 'Rat_HM_Ephys_TD_R13_16_Overview_StudyDay_Condition.xlsx')
    ...
    for region in ['HPC']:
        ...
        for studyday in os.listdir(dir_data):
            ...
            for sleep_period in sleep_periods:
                ...
                dir_ripple = os.path.join(dir_R13_16_Ripple, str(rat), studyday, sleep_period)
                ...
                dir_scoring = os.path.join(dir_R13_16_Scoring, str(rat), str(studyday), sleep_period)
...
# ---- Find ripple CSVs ----
dir_ripple = os.path.join(dir_R13_16_Ripple, rat, studyday, sleep_period)
csv_threshold = os.path.join(dir_ripple, f"{trial_id}_hippocampal_ripples_threshold.csv")
csv_threshold2 = os.path.join(dir_ripple, f"{trial_id}_hippocampal_ripples_threshold2.csv")
