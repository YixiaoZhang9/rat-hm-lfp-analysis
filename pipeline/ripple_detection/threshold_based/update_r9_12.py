...
dir_R9_12_Data = os.path.join(
    dir_base1, "Rat_HM_Ephys_TD_Analysis_R9_16/R9-12/PreprocessedData"
)
dir_R9_12_Scoring = os.path.join(
    dir_base1, "Rat_HM_Ephys_TD_Analysis_R9_16/R9-12/Scoring"
)
...
for rat in [rats[0]]:  # rat in [rats[3]]
    ...
    for region in [regions[0]]:  # e.g. 'HPC'
        ...
        folders_SD = [
            name
            for name in os.listdir(dir_R9_12_Data_perday)
        ...
        for studyday in [folders_SD[14]]:
            ...
            for sleep_period in [sleep_periods[1]]:
                dir_R9_12_Data_pertrial = os.path.join(
                    dir_R9_12_Data_perday, studyday, sleep_period
                )
