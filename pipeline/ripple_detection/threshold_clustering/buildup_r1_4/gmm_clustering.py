...
dir_R1_4_Data = os.path.join(
    dir_base1,
    'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4/PreprocessedData'
)

# ====================== Load feature data ======================
total_df = pd.read_csv("../../../../results/All_Rat1-4_Ripple_Features_17features_test_3.5SD_0.5.csv")
...
for cluster_id in sorted(total_df[label_col].unique()):
    ...
    samples = cluster_data.sample(n=min(n_samples_per_cluster, len(cluster_data)), random_state=42)
