...
# ======================= Load Data ==========================
total_df = pd.read_csv("../../../../results/All_Rat13-16_Ripple_Features_17features.csv")
...
scatter = ax.scatter(
    ...
    c=total_df['GMM_label'], cmap='Set2_r', s=10, alpha=0.8
)
...
for cluster_id in sorted(total_df[label_col].unique()):
    ...
    for _, row in samples.iterrows():
        ...
        mat_path = os.path.join(
            dir_R13_16_Data, region, str(rat), str(studyday), sleep_period, trial_name
        )
