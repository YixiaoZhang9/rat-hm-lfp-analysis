...
# ============================================ time domain features ===========================================
                        ...
                        envelop_features = Ripple_features.ripple_envelop_features(ripple_envelop, ripple_segment,
                                                                                   ripple_segment_filt, fs,
                                                                                   rel_start_ind, rel_end_ind, plot = 0)

                        time_domain_features = Ripple_features.ripple_time_domain_features(ripple_segment, ripple_segment_filt,
                                                                                           fs, rel_start_ind, rel_end_ind,
                                                                                           plot = 0)
...
total_df.to_csv('All_Rat13-16_Ripple_Features_17features.csv', index=False)
