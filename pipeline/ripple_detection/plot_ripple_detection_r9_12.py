...
dir_condition = os.path.join(dir_data_root, 'Rat_HM_Ephys_TD_R9_12_Overview_StudyDay_Condition.xlsx')
    ...
    for region in ['HPC']:
        ...
        for studyday in os.listdir(dir_data):
            ...
            for sleep_period in sleep_periods:
                ...
                dir_ripple = os.path.join(dir_R9_12_Ripple, str(rat), studyday, sleep_period)
