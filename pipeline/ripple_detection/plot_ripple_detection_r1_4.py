...
dir_data_root = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R1-4')
dir_R1_4_Data = os.path.join(dir_data_root, 'PreprocessedData')
dir_R1_4_Scoring = os.path.join(dir_data_root,'Scoring')
dir_R1_4_Ripple = os.path.join(dir_data_root,'Ripple_detection_results')
dir_condition = os.path.join(dir_data_root, 'Rat_HM_Ephys_TD_R1_4_Overview_StudyDay_Condition.xlsx')
    ...
    for region in ['HPC']:
        ...
        for studyday in os.listdir(dir_data):
            ...
            for sleep_period in sleep_periods:
                ...
                dir_ripple = os.path.join(dir_R1_4_Ripple, str(rat), studyday, sleep_period)
                ...
                dir_scoring = os.path.join(dir_R1_4_Scoring, str(rat), str(studyday), sleep_period)
...
# remove the data on 20221101 in rat3 (super noisy signal)
df = df[~((df['rat'] == 'rat3') & (df['day'] == '20221101'))]
...
# ---- Find ripple CSVs ----
dir_ripple = os.path.join(dir_R1_4_Ripple, rat, studyday, sleep_period)
csv_threshold = os.path.join(dir_ripple, f"{trial_id}_hippocampal_ripples_threshold.csv")
csv_threshold2 = os.path.join(dir_ripple, f"{trial_id}_hippocampal_ripples_threshold2.csv")
