...
# model_path = ripplenet_model_dir /"best_model_finetuned_sim_main3.pkl"  # ripplenet
model_path = ripplenet_model_dir /"model_training"/"retrained_model.pkl" # ripplenet2
...
# model = keras.models.load_model(ripplenet_model_dir / "ripplenet_finetuned_sim_main3.h5",compile=False) # ripplenet
model = keras.models.load_model(ripplenet_model_dir /"model_training"/ "retrained_model.h5",compile=False) # ripplenet2
model.summary()
...
dir_output = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis_New/R5-8/Ripple_detection_results')
...
for rat in rats:
    ...
    for region in [regions[0]]:
        ...
        folders_SD = [d for d in os.listdir(dir_R5_8_Data_perday)
                      if os.path.isdir(os.path.join(dir_R5_8_Data_perday, d))]
        ...
        for studyday in folders_SD:
            ...
            for sleep_period in sleep_periods:
                ...
                path_scoring = os.path.join(dir_R5_8_Scoring, str(rat), studyday, sleep_period)
