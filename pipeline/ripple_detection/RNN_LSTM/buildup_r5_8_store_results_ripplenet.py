...
model_path = (
    ripplenet_model_dir / "model_training" / "retrained_model.pkl"
)  # ripplenet2
...
model = keras.models.load_model(
    ripplenet_model_dir / "model_training" / "retrained_model.h5", compile=False
)  # ripplenet2
model.summary()
...
for rat in rats:
    ...
    for region in [regions[0]]:
        ...
        folders_SD = [
            d
            for d in os.listdir(dir_R5_8_Data_perday)
                ...
                for root, _, files in os.walk(dir_trial):
                    for name in files:
                        ...
                        save_path = os.path.join(
                            output_dir, f"{trial_id}_hippocampal_ripples_ripplenet2.csv"
                        )
