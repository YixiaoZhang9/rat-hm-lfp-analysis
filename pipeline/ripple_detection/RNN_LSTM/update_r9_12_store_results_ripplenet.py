...
model = keras.models.load_model(ripplenet_model_dir / "ripplenet_finetuned_sim_main3.h5",compile=False)
model.summary()
...
dir_output = os.path.join(dir_base1,'Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R9-12/Ripple_detection_results')
...
for rat in rats:
    ...
    for region in [regions[0]]:
        ...
        folders_SD = [d for d in os.listdir(dir_R9_12_Data_perday)
        ...
        for studyday in folders_SD:
            ...
            for sleep_period in sleep_periods:
                ...
                path_scoring = os.path.join(dir_R9_12_Scoring, str(rat), studyday, sleep_period)
                ...
                for root, _, files in os.walk(dir_trial):
                    for name in files:
                        ...
                        save_path = os.path.join(output_dir, f"{trial_id}_hippocampal_ripples_ripplenet.csv")
