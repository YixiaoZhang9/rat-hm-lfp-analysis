...
model_path = ripplenet_model_dir /"best_model_finetuned_sim_main3.pkl"  #from main experiemnt
    ...
    for region in [regions[0]]:
        ...
        for studyday in folders_SD:
            ...
            for sleep_period in sleep_periods:
                ...
                path_scoring = os.path.join(dir_R1_4_Scoring, str(rat), studyday, sleep_period)
