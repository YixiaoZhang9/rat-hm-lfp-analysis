...
dir_R9_12_Scoring = os.path.join(
    dir_base2, "Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R9-12/Scoring"
)
dir_R9_12_Ripple = os.path.join(
    dir_base2, "Rat_HM_Ephys_TD/Rat_HM_Ephys_TD_Analysis/R9-12/Ripple_detection_results"
)
