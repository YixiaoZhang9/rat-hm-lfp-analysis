...
def find_deltas_lfp_hilbert(raw_signal, signal, fs=1000,thresholds=(1, 2, 0, 1.5),durations=(150, 500), f_plot=False,plot_range=None):
    """
    ...
    if f_plot:
        ...
        ax2.axhline(highPeak,
                    color='green')

        ax2.axhline(-lowTrough,
                    color='purple',
                    linestyle='--')

        ax2.axhline(-highTrough,
                    color='purple')
